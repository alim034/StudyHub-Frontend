...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center relative pb-20 px-4">
            ...
            {/* Main Register Card - Same compact size as login */}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-4 bg-white/8 border border-white/20 rounded-xl text-white/90 placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 focus:bg-white/12 backdrop-blur-sm transition-all duration-300 text-sm sm:text-base"
                                        required
                                        disabled={loading}
                                    />
                                    <button
